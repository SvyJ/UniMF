...
def encode_text_with_prompt_ensemble(model, objs, tokenizer, device, dataset='mvtec'):
    ...
    for obj in objs:
        ...
        if dataset == 'mvtec':
            ...
            # damaged {} + {} with defect + {} with defect
        elif dataset == 'mvtec3d':
            prompt_state[1] = state_anomaly + mvtec3d_class_state_abnormal[obj] + class_state[obj]
        elif dataset == 'eyecandies':
            prompt_state[1] = state_anomaly + eyecandies_class_state_abnormal[obj] + class_state[obj]
        else:
            prompt_state[1] = state_anomaly + visa_class_state_abnormal[obj] # + class_state[obj] 
            # damaged {} + {} with scratch
...
mvtec3d_class_state_abnormal = {
    'object': ['combined {}', '{} with contamination', '{} with crack', '{} with hole',
        '{} without defect', '{} without anomaly',
        '{} with bent', '{} with cut', '{} with hole', '{} with thread',
        'combined {}', '{} with contamination', '{} with crack', '{} with cut', '{} with hole',
        'combined {}', '{} with contamination', '{} with crack', '{} with hole',
        '{} with bent', 'combined {}', '{} with contamination', '{} with cut',
        '{} with color stain', 'combined {}', '{} with contamination', '{} with cut',
        'combined {}', '{} with contamination', '{} with cut', '{} with hole',
        'combined {}', '{} with contamination', '{} with cut', '{} with hole',
        '{} with contamination', '{} with cut', 'open {}',
        'combined {}', '{} with contamination', '{} with cut', '{} with hole']}
